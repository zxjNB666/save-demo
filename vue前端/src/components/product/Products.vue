<template>
    <div id="productCategroys">
        ...
        <el-card class="box-card">
                    ...
                    <el-table-column prop="imageUrl" label="图片" align="center" width="150px" padding="0px">
                        ...
                        <template slot-scope="scope">
                            <el-popover placement="right" trigger="hover">
                                <img :src="'http://42.192.55.221/'+scope.row.imageUrl"
                                     style="height: 200px;width: 200px"/>
                                <img slot="reference" :src="'http://42.192.55.221/'+scope.row.imageUrl"
            ...
            <el-button type="text" size="mini" slot="reference" icon="el-icon-back"  @click="back(scope.row.id)">恢复</el-button>
            ...
            <el-button type="text" slot="reference" size="mini" icon="el-icon-s-operation" @click="remove(scope.row.id)">回收站</el-button>
              ...
              <el-button type="text" slot="reference" size="mini" icon="el-icon-s-operation" @click="publish(scope.row.id)">通过</el-button>
            ...
            async edit(id) {
                ...
                if (res.code == 200) {
                    ...
                    this.imgFilesList.push({
                        url: "http://42.192.55.221/" + item.imageUrl,
                        name: item.name,
                        id: item.id
                    });
                } else {
