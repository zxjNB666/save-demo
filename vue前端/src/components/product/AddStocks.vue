              ...
              <el-table-column prop="imageUrl" label="图片" align="center" width="150px" padding="0px">
                ...
                <template slot-scope="scope">
                  <el-popover placement="right"  trigger="hover">
                    <img :src="'http://42.192.55.221/'+scope.row.imageUrl"  style="height: 200px;width: 200px"/>
                    <img  slot="reference" :src="'http://42.192.55.221/'+scope.row.imageUrl" :alt="scope.row.imgUrl" style="height: 32px;width: 32px;cursor: pointer">
                  </el-popover>
                </template>
              </el-table-column>
