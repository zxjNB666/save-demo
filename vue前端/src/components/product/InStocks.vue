        ...
        <el-card>
            ...
            <el-table size="mini" v-loading="loading" :data="tableData" border style="width: 100%;" height="420">
                ...
                <el-table-column label="操作" fixed="right" width="200">
                 ...
                 <el-button type="text" slot="reference" size="mini" icon="el-icon-s-operation" @click="remove(scope.row.id)">回收站</el-button>
        
                        </span>
                        <!--   给操作员使用的按钮(回收站)-->
                        <span v-if="scope.row.status==1">
                            
                            <el-button type="text" slot="reference" size="mini" icon="el-icon-s-operation" @click="back(scope.row.id)">还原</el-button>
                       
                              
                            <el-button type="text" slot="reference" size="small" icon="el-icon-delete" @click="del(scope.row.id)">删除</el-button>
                        ...
                        <el-button type="text" slot="reference" size="small" icon="el-icon-refresh"  @click="publish(scope.row.id)">通过</el-button>
          ...
          <template>
            <el-table height="260" max-height="350" border :data="detailTable" style="width: 100%">
              ...
              >
                <template slot-scope="scope">
                  <img
                          :src="'http://42.192.55.221/'+scope.row.imageUrl"
                          alt
